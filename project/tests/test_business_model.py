...
class TestBusinessModel(BaseTestCase):
    ...
    def test_add_business(self):
        business = add_business('Drarter Homes', 'Technology','Garden City Mall', 'Dealers in smart home technology.', 'junekid')
        ...
        self.assertTrue(business.business_desc, 'Dealers in smart home technology.')
