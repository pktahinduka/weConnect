...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        user = add_user('michael','michael@realpython.com', 'micheal')
        db.session.add(user)
        db.session.commit()
    ...
    def test_all_users(self):
        ...
        add_user('michael', 'michael@realpython.com','micheal')
        add_user('fletcher', 'fletcher@realpython.com','fletcher')
        with self.client:
    ...
    def test_main_with_users(self):
        ...
        add_user('peter','petertahinduka@gmail.com','petero')
        add_user('paul','paulampurire@gmail.com','paulo')
        add_user('jean','jeantahinduka@gmail.com','fortunate')
        add_user('moses','mosesampurire@gmail.com','mansamusa')
        response = self.client.get('/')
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'<h1>All Users</h1>', response.data)
